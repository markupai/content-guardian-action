...
const createFileAnalysisResults = (
  filePaths: string[],
...
const mockAnalyzeFiles = jest.fn() as jest.MockedFunction<
...
const mockCreateFileDiscoveryStrategy = jest.fn() as jest.MockedFunction<
  () => MockStrategy
>
  ...
  describe('when strict mode is not specified', () => {
    beforeEach(() => {
      mockCore.getInput.mockImplementation(
        createInputMockWithOverrides({ strict_mode: '' })
      )
    })
