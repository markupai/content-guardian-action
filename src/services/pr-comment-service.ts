...
function generateCommentBody(
  ...
  const header = `<h2><span style="display: inline-flex; align-items: center; gap: 6px;"><img src="${logoUrl}" alt="Markup AI" width="28" height="28" /> <span>Markup AI Analysis Results (DEV)</span></span></h2>
