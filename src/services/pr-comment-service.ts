...
function generateCommentBody(
  ...
  const header = `## <img src="${LOGO_URL}" alt="Markup AI" width="32" height="32" /> Markup AI Analysis Results (DEV)
...
function buildReviewCommentBody(issues: AnalysisIssue[]): string {
  ...
  return `**Markup AI** detected issues: <img src="${LOGO_URL}" alt="Markup AI" width="16" height="16" align="right" />\n${issueLines.join(
    "\n",
  )}`;
}
