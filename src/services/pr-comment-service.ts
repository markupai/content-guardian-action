...
function generateCommentBody(
  ...
  const header = `## <img src="${logoUrl}" alt="Markup AI" width="20" height="20" style="vertical-align: text-bottom;" /> Markup AI Analysis Results (DEV)
