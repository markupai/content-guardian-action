...
function generateCommentBody(
  ...
  const header = `## Markup AI Analysis Results (DEV) <img src="${LOGO_URL}" alt="Markup AI" width="32" height="32" align="right" />
...
function buildReviewCommentBody(issues: AnalysisIssue[]): string {
  ...
  return `**Markup AI** detected issues: <img src="${LOGO_URL}" alt="Markup AI" width="24" height="24" align="right" />\n${issueLines.join(
    "\n",
  )}`;
}
