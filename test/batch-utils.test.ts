...
describe("Batch Utils", () => {
  ...
  describe("processBatch", () => {
    ...
    it("should process multiple items in single batch", async () => {
      ...
      const processor = createMockProcessor(["processed1", "processed2", "processed3"]);
    ...
    it("should add delay between batches", async () => {
      ...
      expect(result).toEqual(["processed1", "processed2", "processed3", "processed4"]);
    });
    ...
    it("should log progress information", async () => {
      ...
      expect(core.info).toHaveBeenCalledWith("🚀 Processing 3 items in 1 batches");
      expect(core.info).toHaveBeenCalledWith("📦 Processing batch 1/1 (3 items)");
  ...
  describe("processWithConcurrency", () => {
    ...
    it("should log progress information", async () => {
      ...
      expect(core.info).toHaveBeenCalledWith("🚀 Processing 3 items with max concurrency of 2");
      expect(core.info).toHaveBeenCalledWith(
    ...
    it("should handle undefined results from failed operations", async () => {
      const items = ["item1", "item2", "item3"];
      const processor = createMockProcessorWithError(["processed1", undefined, "processed3"]);
  ...
  describe("processFileReading", () => {
    ...
    it("should filter out files with null content", async () => {
      ...
      const readFileContent = createMockFileReader(["content1", null, "content3"]);
  ...
  describe("Semaphore (internal)", () => {
    it("should handle concurrent access correctly", async () => {
      ...
      const processor = createConcurrencyTestProcessor(concurrentCount, maxConcurrent);
