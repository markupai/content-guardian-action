...
const setupExistingComment = (commentId: number): void => {
  ...
  mockFn.mockResolvedValue({
    data: [
      {
        id: commentId,
        body: '<table><tr><td><img src="https://github.com/markupai/content-guardian-action/raw/unlock%2FAdd-review-commit-with-suggestion/icons/markup_ai_mark_logo.svg" alt="Markup AI" width="28" height="28" /></td><td><strong>Markup AI Analysis Results (DEV)</strong></td></tr></table>\n\nThis comment was automatically generated by the Markup AI GitHub Action for **pull_request** event.\nSome old content',
      },
    ],
  });
};
...
describe("PR Comment Service", () => {
    ...
    describe("successful scenarios", () => {
      it("should create new comment when no existing comment found", async () => {
        ...
        expect(mockOctokit.rest.issues.createComment).toHaveBeenCalledWith({
          ...
          repo: "test-repo",
          issue_number: 123,
          body: expect.stringContaining("<table><tr><td><img"),
        });
      });
  ...
  describe("Comment content generation", () => {
    it("should generate proper markdown table with emojis", async () => {
      ...
      expect(commentBody).toContain("<table><tr><td><img");
