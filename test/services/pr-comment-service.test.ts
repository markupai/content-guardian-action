...
const setupExistingComment = (commentId: number): void => {
  ...
  mockFn.mockResolvedValue({
    data: [
      {
        id: commentId,
        body: '<h2><img src="https://github.com/markupai/content-guardian-action/raw/unlock%2FAdd-review-commit-with-suggestion/icons/markup_ai_mark_logo.svg" alt="Markup AI" width="28" height="28" align="absmiddle" /> Markup AI Analysis Results (DEV)</h2>\n\nThis comment was automatically generated by the Markup AI GitHub Action for **pull_request** event.\nSome old content',
      },
    ],
  });
};
