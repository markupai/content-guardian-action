...
describe("Display Utils", () => {
  ...
  describe("displayEventInfo", () => {
    it("should display event information correctly", () => {
      ...
      expect(core.info).toHaveBeenCalledWith("📄 Description: Files modified in push event");
    ...
    it("should display event information without additional info", () => {
      ...
      expect(core.info).toHaveBeenCalledWith("📄 Description: Files changed in pull request");
    ...
    it("should handle empty additional info", () => {
      ...
      expect(core.info).toHaveBeenCalledWith("📄 Description: Manual workflow trigger");
  ...
  describe("displayResults", () => {
    ...
    it("should handle empty results array", () => {
      ...
      expect(core.info).toHaveBeenCalledWith("📊 No analysis results to display.");
  ...
  describe("displaySectionHeader", () => {
    ...
    it("should handle long title", () => {
      const longTitle = "This is a very long section title that should still work correctly";
  ...
  describe("displaySubsectionHeader", () => {
    ...
    it("should handle long title", () => {
      const longTitle = "This is a very long subsection title that should still work correctly";
